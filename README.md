...
## 2022-3-1更新：（IPV6大全版5.4.175内核【带DOCKER】 + IPV6精简版5.4.175内核 + IPV6极致版5.4.175内核  + IPV6极致版5.4.175内核 +R2S大全版5.4.175【带DOCKER】 +R4S大全版5.4.175【带DOCKER】  ）

一.同步更新所有源码和插件到2022年3月1日
...
1.修复上一版本动态DNS中 看不到dnspod提供商问题。

2.所有版本内核编译统一5.4.175内核。

4.同步更新最新插件，基本无BUG。

5.应TG群网友建议，极致版取消mosdns插件。

6.应TG群网友建议，R2S和R4S此次版本集成DOCKER

## 2022-2-21更新：（IPV6大全版5.10.100内核【带DOCKER】 + IPV6精简版5.10.100内核 + IPV6极致版5.15.32内核 ）【养老版】

一.同步更新所有源码和插件到2022年2月20日
...
1.升级DOCKER版本，增加TTYD功能。

2.增加INTEL I225网卡2.5G驱动支持。

3.取消精简和极致中状态菜单中wireguard显示。

4.更新【DDNS】，升级新版本阿里和腾讯域名解析脚本.

5.【独有优化】修复mosdns插件 dns转发ipv6启用后，重启自动取消问题。

6.升级插件【高级设置1.20版】，一键应用设置IPV4网络和IPV6网络。

7.修复【UPNP】自动启动IGDv1 模式，某些老机器如果无UPNP可以不选择它试试。

8.因源码升级插件路径变更，修复插件名字和分类错乱等美观问题.

9.大全和精简都加入bypass，其中极致版5.15内核 集成sirpdboy自用的【bypass】.

10.【首家独有优化】预览页增加【内核温度】显示，如果是虚拟机则 无温度。

11.升级Opentopd主题1.4.9版本，修复监控显示版面错位等问题。

12.生成固件文件名中新增加内核参数方便区分。如：【20220221-Ipv6-Mini-5.10-x86-64-generic-squashfs-combined-efi.img】

表示：2022年2月19日，Ipv6-Mini精简版，5.10内核，X86版本，EFI引导等。

## 2022-2-14更新：（IPV6大全版5.10.100内核【带DOCKER】 + IPV6精简版5.10.100内核 + IPV6极致版5.10.100内核  + IPV6 2102官方源码极致版5.4.154内核【情人节特别版】 +R2S大全版【带DOCKER】 +R4S大全版【带DOCKER】  ）

一.同步更新所有源码和插件到2022年2月14日
...
1.修复酸酸乳++ 状态 谷哥，油管网站等测试速度BUG,此版本为 sirpdboy自用版 。

2.更新插件BYPASS开启GFW模式无效问题。

4.同步更新最新插件，基本无BUG。

5.增加2102官方源码编译5.4内核支持2.5G网卡，注意：此版本仅5个插件【openclash,彩旗vssr，酸酸乳++，passwall，bypass(sirpdboy自用版)】，极致到家。

## 2022-1-15更新：（IPV6大全版5.10.91内核【带DOCKER】 + IPV6精简版5.10.91内核 + IPV6极致版5.10.91内核 ）

一.同步更新所有源码和插件到2022年1月15日
