...
## 2023年10月16日 更新  进入本群固件交流群：https://t.me/+RV6mxIxZJVDByibQ   【与更多好伙伴一起聊天侃地】【sirpdboy独家优化】
- 普通极致2102分支SUPER版5.4内核/无应用商店/无docker/后台加载全部驱动/2G
- VIP大全1806分支PLUS版6.1内核/应用商店/docker/部分驱动/1G
- VIP精简2305分支MINI版5.15内核/应用商店/后台加载docker /部分驱动/2G
- VIP旁路2102分支BYPASS版5.4内核/应用商店/后台加载docker/后台加载全部驱动/2G
- VIP极致2102分支SUPER版5.4内核/应用商店/后台加载docker/后台加载全部驱动/2G
- VIP R2S 版1806分支6.1内核 /应用商店/docker /1G
- VIP R4S 版1806分支6.1内核 /应用商店/docker/1G
- VIP R4SE 版1806分支6.1内核/应用商店/docker/1G
- VIP R5C 版1806分支6.1内核/应用商店/docker/1G
- VIP R5S 版1806分支6.1内核/应用商店/docker/1G
- 在上一版本的基础上优化更新如下：
- 1.DDNS-GO 5.6.3版本 
- 2.KUCAT主题更新 ，取消装载动画，解决点击链接后导致卡住问题。适配官方2305分支
- 3.进阶设置（kucat/argon/Design/opentopd四种主题设置+高级设置） 适配官方2305分支
- 4.升级概览页，加入查看多核CPU负载占用，让概览功能更强大。
- 5.升级MINI版为23.05分支，解决多拨多线负载无效问题。
- 6.1806分支保持原来1G大小，2102和2305都是2G大小。请大家注意。如果是老版本升级需要全新安装，不可直接升级。如果是2G的可以直接升级1G版本。
...
- VIP极致SUPER版5.4.255内核/应用商店/无docker （固件终端或SSH登陆后用10号功能一键加载所有PCI/USB/无线网卡驱动，11号功能一键加载DOCKER服务。）
- VIP R2S 版6.1内核 /应用商店/docker VIP R4S 版6.1内核 /应用商店/dockerVIP R4SE 版6.1内核/应用商店/docker

- 主要更新内容如下：【在上个版本的基础上优化更新如下】
- 一、升级进阶设置，修复上一版本设置扩展工具栏，导致主题出错问题。增加Design主题设置和Design主题。
- 二、升级酷猫主题，字体恢复之前版本大小。解决下拉列表图标不一致，显示不够整齐等问题。
- 三、所有版本增加亚洲区时间校验，解决某些机器时间过快问题。
- 四、升级adguardhome，解决adguardhome进入键钮颜色浅色问题。
- 五、升级CHATGPT，解决23.05版本上使用cgi报错错问题，修正在暗色模式也是亮色的等问题。
- 六、目前VIP极致版2G分区，插件和功能和上一版一样保持不变，其他版本升级到极致不能[备份/升级]必须全新刷机，如果已经刷2G分区极致可直接[备份/升级]到其他版本.其他跨版本升级可[备份/升级]。注：不要保- 留配置升级，减少各种不可描述的问题。
- 七、历史版本中 增加【经典稳定版本】专区。更多功能请自行刷机测试。

## 2023年9月18日 更新， 进入本群固件交流群：https://t.me/+RV6mxIxZJVDByibQ   【与更多好伙伴一起聊天侃地】

- VIP极致丝滑体验版下载：https://www.123pan.com/s/dS5A-qNJqd.html 提取码: BIsW
- 一、升级酷猫主题，大量优化更适合手机操作。字体默认精细美观版本，需要大字体的伙伴：进阶设置 - 酷猫主题-关怀模式【独家研究】。
- 二、升级进阶设置，高级功能中可取消SSH登陆菜单，可以设置HTTPS访问等【独家研究】。
- 三、VIP极致丝滑体验版（【21.02】5.4内核可适配更多网卡驱动），
- 重大突破：1、酷猫主题适配最新21.02以上版本，主题追求极致流畅和显示位置等精细优化，基本无显示错位等问题【独家研究首推】。
 -                  2、不能识别的网卡，在固件终端或SSH登陆后用10号功能一键加载所有PCI/USB/无线网卡驱动【独家研究首推】。
-                   3、针对某些好伙伴不用docker和docker刚需的要求，在固件终端或SSH登陆后11号功能一键加载DOCKER服务【独家研究首推】。
- 四、DDNS-GO 升级5.6.2
- 五、加回上一版本任务设置，修复任务设置中，自定义脚本执行不生效的BUG【独家研究】。
- 六、此次升级不同处：1.内核为5.4.255版 。2.极致版分区从1G加到2G。3.增加ALIST，应用商店和bypass。
- 七、同步更新所有插件到最新版本。另集成：openclash，passwall,mosdns，smartdns,chatgpt,docker(后台菜单动态加载)，设置向导，进阶设置，家长控制，任务设置，定时限速等。
- 八、此次更新极致版分区调整其它版本不变 ，注意：全新刷机！！全新刷机！！全新刷机！！
...
- 【123网盘固件下载】主下载: https://www.123pan.com/s/dS5A-nJxqd.html 提取码: nxFY
